...
Opening a pull request will trigger a[workflow](../.github/workflows/az_mlops_demo-run-tests.yml) 
...
* [Staging model in UC](https://e2-demo-field-eng.cloud.databricks.com/explore/data/models/staging/az_mlops_demo/az_mlops_demo-model)
* [Prod model in UC](https://e2-demo-field-eng.cloud.databricks.com/explore/data/models/prod/az_mlops_demo/az_mlops_demo-model)
. 
