...
git add README.md docs .gitignore az_mlops_demo/resources/README.md
...
If you want to use different catalog names, please update the target names declared in the[az_mlops_demo/databricks.yml](../az_mlops_demo/databricks.yml) file. 
...
Follow the instructions in [az_mlops_demo/resources/README.md](../az_mlops_demo/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../az_mlops_demo/resources/README.md)  to propose, test, and deploy
