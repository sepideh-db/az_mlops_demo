...
# ``az_mlops_demo/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-az_mlops_demo-experiment",
    label="MLflow experiment name",
)
# Unity Catalog registered model name to use for the trained mode.
dbutils.widgets.text(
    "model_name", "dev.az_mlops_demo.az_mlops_demo-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.az_mlops_demo.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.az_mlops_demo.trip_dropoff_features",
...
param = {"num_leaves": 25, "objective": "regression", "metric": "rmse"}
num_rounds = 100
